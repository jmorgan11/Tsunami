"""
Filename: populate_content_deduct.py
Purpose: Populate the ContentDeductible and DefaultContDeductible_Flag fields
Author: Jesse Morgan
Date: 5/29/2026
Updates: None
...
def main(in_fc):
    ...
    try:
        ...
        arcpy.management.CalculateField(
            in_table=in_fc,
            field="DefaultContDeductible_Flag",
            expression="0",
            expression_type="PYTHON3")
